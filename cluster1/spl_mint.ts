...
// Mint address
const mint = new PublicKey("GXDkHuwAk95oNskerYJfxJDMfRV3srthVKGrBPG6UbPV");
...
(async () => {
    try {
        ...
        // Mint to ATA
        const mintTx = await mintTo(connection,keypair,mint,ata.address,keypair.publicKey,1n*1_000_000n);
